...
def get_limit_info(user_id: int) -> str:
    ...
    return (
        ...
        "Додаткові перевірки можуть бути надані користувачам, які підтримали проєкт.\n"
        "Для цього відкрий <b>«💙 Підтримати»</b> і надішли скріншот підтримки саме в цьому розділі."
    )
