...
ABOUT_TEXT = (
    ...
    "Надішли текст — бот поверне вердикт із короткою причиною, поясненням і джерелами перевірки.\n\n"
    "<b>У групі</b>\n"
    ...
    "Добровільно підтримати AntiFakeUA можна через <code>/support</code>. Після переказу відкрий розділ <b>«Підтримати»</b> і надішли скріншот оплати для отримання додаткового ліміту."
)
