...
WELCOME_TEXT = (
    "<b>AntiFakeUA_Bot</b> — перевірка новин на фейки, маніпуляції та сумнівні твердження.\n\n"
    "<b>Що можна надіслати:</b>\n"
    "• текст новини або заяви;\n"
    "• пересланий допис із Telegram;\n"
    "• коротке твердження, яке треба перевірити.\n\n"
    "<b>Як користуватись:</b> просто надішли повідомлення в цей чат. "
    "У групах бот працює через команду <code>/check</code> у відповіді на потрібний допис.\n\n"
    "Нижче — основні розділи бота."
)

ABOUT_TEXT = (
    "<b>ℹ️ Про бота і як користуватись</b>\n\n"
    "AntiFakeUA_Bot допомагає швидко розібратися, чи схоже повідомлення на правду, "
    "фейк, маніпуляцію, непідтверджену інформацію або стару новину, подану як нову.\n\n"
    "<b>В особистому чаті</b>\n"
    "1. Надішли текст новини, заяви або підозрілого повідомлення.\n"
    "2. Дочекайся результату перевірки.\n"
    "3. Отримай вердикт, пояснення і публічний код перевірки.\n\n"
    "<b>У групі</b>\n"
    "• відповідай командою <code>/check</code> на повідомлення, яке треба перевірити;\n"
    "• або напиши <code>/check текст твердження</code>.\n"
    "Так бот не втручається в усі повідомлення групи.\n\n"
    "<b>Чим корисний результат</b>\n"
    "• показує головне твердження;\n"
    "• пояснює, чому інформація виглядає достовірною або сумнівною;\n"
    "• допомагає помічати емоційний тиск, клікбейт і підміну контексту;\n"
    "• дає публічний код, щоб інші могли відкрити цю ж перевірку через бота.\n\n"
    "<b>Важливо:</b> бот не замінює журналістське розслідування, але допомагає швидко отримати "
    "аргументовану попередню оцінку."
)

TRANSPARENCY_TEXT = (
    "<b>🔗 Відкритість і посилання</b>\n\n"
    "AntiFakeUA_Bot має бути зрозумілим для користувача: не просто ставити ярлик, "
    "а пояснювати, яке твердження перевіряється і чому зроблено саме такий висновок.\n\n"
    "У цьому розділі можна відкрити код проєкту, методологію та prompt перевірки, "
    "щоб побачити логіку роботи бота."
)

SOURCE_HELP_TEXT = (
    "<b>🌐 Репутація джерела</b>\n\n"
    "Бот поступово накопичує статистику про сайти, домени й Telegram-канали, "
    "які трапляються в перевірках.\n\n"
    "Це не остаточний вирок джерелу, а історія його появ у базі AntiFakeUA: "
    "у яких перевірках воно зустрічалося і з якими результатами.\n\n"
    "Приклади запиту:\n"
...
FEEDBACK_TEXT = (
    "<b>✉️ Відгук або повідомлення про помилку</b>\n\n"
    "Напиши, що саме не спрацювало або що варто покращити.\n\n"
    "Можна надіслати:\n"
    "• скаргу на неточну відповідь;\n"
    "• повідомлення про проблему з оплатою;\n"
    "• ідею для нової функції;\n"
    "• приклад новини, яку бот перевірив погано.\n\n"
