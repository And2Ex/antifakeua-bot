...
def get_limit_info(user_id: int) -> str:
    ...
    return (
        ...
        "<b>Як розширити ліміт</b>\n"
        "Відкрий <b>«💙 Підтримати»</b> або команду <code>/support</code>, зроби добровільний переказ і надішли скріншот оплати. "
        "Після підтвердження адміністратор додасть перевірки до твого додаткового ліміту."
    )
