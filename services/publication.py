...
1. У заголовку і тексті коректно передай, який контекст, уточнення або виправлення потрібні.
2. Не називай повідомлення "фейком", якщо встановлена лише оманлива подача, перебільшення або неповний контекст.
3. Коротко назви початкове твердження та відразу наведи встановлений коректний контекст.

Правила для verdict_family = "false":
1. Заголовок має чітко відображати, що ключове повідомлення неправдиве або підроблене.
2. У тексті коротко назви поширене твердження та відразу наведи встановлене спростування.
