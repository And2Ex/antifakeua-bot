...
WELCOME_TEXT = (
    ...
    "<b>Як почати:</b> надішли текст новини, посилання на публікацію або перешли допис із Telegram у цей чат.\n"
    "У групі відповідай командою <code>/check</code> на повідомлення, яке треба перевірити.\n\n"
    "<b>Для адміністраторів каналів:</b> команда <code>/quickcheck</code> дозволяє ввімкнути автоматичні короткі позначки або вручну перевірити останній допис каналу.\n\n"
...
ABOUT_TEXT = (
    ...
    "• новини та заголовки;\n"
    "• посилання на дописи або новини в інтернеті;\n"
    ...
    "Надішли текст, посилання або перешли допис із Telegram — бот поверне вердикт із короткою причиною, поясненням і джерелами перевірки. Для посилання бот перевіряє доступний зміст і пов’язані відкриті джерела; якщо сам допис неможливо надійно прочитати, бот не вигадує його зміст.\n\n"
    "<b>У групі</b>\n"
    "Відповідай командою <code>/check</code> на потрібне повідомлення.\n\n"
    "<b>Для новинних каналів</b>\n"
    "Адміністратор може відкрити <code>/quickcheck</code> у приватному чаті з ботом, увімкнути автоматичні короткі позначки або вручну перевірити останній отриманий ботом допис каналу. Ручну перевірку можна запустити й тоді, коли автоматична позначка не з’явилася; публічна позначка публікується лише за результатом перевірки, якщо для цього є підстава. Натискання на <b>AntiFakeUA</b> у позначці відкриває повний висновок із джерелами.\n\n"
    "<b>Важливо</b>\n"
    ...
    "Добровільно підтримати AntiFakeUA можна в розділі <b>«Підтримати»</b>. Користувачі, які підтримали проєкт, можуть отримати додаткові перевірки; скріншот підтримки потрібно надсилати саме в цьому розділі."
)
