...
ABOUT_TEXT = (
    ...
    "Надішли текст, посилання або перешли допис із Telegram — бот поверне вердикт із короткою причиною, поясненням і джерелами перевірки. Якщо зміст публікації за посиланням неможливо отримати, бот попросить надіслати її текст або переслати допис.\n\n"
    "<b>У групі</b>\n"
