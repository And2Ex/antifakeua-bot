...
5. Якщо у фактчеку є окреме важливе уточнення до правдивої новини, акуратно врахуй його в тексті лише тоді, коли без нього читач може неправильно зрозуміти подію; не перетворюй його на сумнів щодо основної новини.

Правила для verdict_family = "mixed":
1. Для видимого вердикту "Маніпуляція" сформулюй підтверджений факт і коротко поясни викривлення, яке змінює враження читача.
2. Не використовуй абстрактні формулювання "потребує контексту", "є часткове підтвердження" або "потребує уточнення" як заголовок чи основний висновок.
3. Не пом'якшуй спростовану ключову тезу до mixed: такі випадки належать до verdict_family = "false".
