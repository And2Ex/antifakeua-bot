...
<main>
  ...
  <section class="card">
    ...
    <p>AntiFakeUA має безкоштовний ліміт перевірок. Користувачі, які підтримали проєкт, можуть отримати додаткові перевірки.</p>
    <p class="muted">Щоб передати підтвердження підтримки, відкрийте в боті розділ «Підтримати» і надішліть скріншот саме в цьому розділі.</p>
  </section>
